...
public class CommonConfigurationKeys extends CommonConfigurationKeysPublic {
  ...
  /** Ips or users can visit hdfs with no check，format like {ip1:u1|u2,ip2:u3|u4}*/
  public static final String  HADOOP_SECURITY_HDFS_NO_CHACK_VISITOR_MAPPING = "security.hdfs.nocheck.visitor.mapping";

...
public class LeafQueue extends AbstractCSQueue {
  ...
  @Private
  public synchronized List<AppPriorityACLGroup> getPriorityACLs() {
  ...
  public synchronized void updateApplicationPriority(SchedulerApplication<FiCaSchedulerApp> app,
